...
#define     NRF_ESB_TX_FIFO_SIZE                16                   /**< The size of the transmission first in first out buffer. */
#define     NRF_ESB_RX_FIFO_SIZE                2                   /**< The size of the reception first in first out buffer. */
